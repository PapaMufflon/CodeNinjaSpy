...
namespace MufflonoSoft.CodeNinjaSpy
{
    ...
    public sealed class CodeNinjaSpyPackage : Package
    {
        ...
        private void ShowToolWindow(object sender, EventArgs e)
        {
            ...
            var window = (MyToolWindow)this.FindToolWindow(typeof(MyToolWindow), 0, true);
        ...
        protected override void Initialize()
        {
            ...
            if (null != mcs)
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidCodeNinjaSpyCmdSet, (int)PkgCmdIDList.cmdidCodeNinjaSpy);
